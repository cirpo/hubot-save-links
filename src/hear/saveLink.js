...
function persist(linkInfo) {
  ...
  var userName =  linkInfo.msg.user.name;
  var room = linkInfo.msg.room;
  var date = linkInfo.date;
  var link = linkInfo.link;

  client.incr('hubot:links:lastId', function(err,linkId) {
    rdebug(linkInfo);
    var redisCommands = [
        //links
        ...
        ["hset", "hubot:saveLinks:links:user:name:", userName + ":hash", userId + '::' + userEmail],
        //room
